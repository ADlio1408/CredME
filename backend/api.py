...
# ============================================================
# LOAD FAIRNESS / DISPARATE IMPACT REPORT
# ============================================================
#
# Generated by backend/fairness_audit.py. Loaded once at
# startup and served read-only via GET /fairness/report so the
# audit is inspectable without re-running the script.
#
# ============================================================

FAIRNESS_REPORT_PATH = os.path.join(
    MODELS_DIR,
...
try:
    ...
    print(
        "WARNING: fairness_report.json not found. "
        "Run backend/fairness_audit.py to generate it."
    )
...
def health():
    ...
    return {
        ...
        "fairness_report_loaded": fairness_report is not None,
    }
...
# ============================================================
#
# Serves the pre-computed four-fifths-rule audit of the credit
# model's approval decisions across Age and Marital Status.
# Read-only and non-personalized: it reports on the model as a
# whole, not on any individual applicant.
#
# ============================================================
